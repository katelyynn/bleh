...
export const trans = {
    ...
    remove_friend: {
        ...
        body: {
            ...
            pl: 'Czy nadal chcesz usunąć {u} z listy bliskich znajomych? (tylko „bleh”)',
        },
    },
    added_as_friend: {
