...
export const trans = {
    ...
    inverse_compare: {
        ...
        body: {
            ...
            pl: 'Zamiast tego pokaż rzeczy, których nie udostępniasz',
        },
    },
    one_page: {
        en: '1 page',
    ...
    friend_difference: {
        ...
        pl: 'Bliscy znajomi to system, który pozwala śledzić historię odtwarzania utworów przez znajomych, ale nie ma wpływu na listę obserwowanych.',
    },
    ...
    themes: {
        ...
        dark: {
            ...
            pl: 'Popiół', // imo Popiół fits better here than "Kurz" -- which means dust 
            zh: '烟灰',
        },
        darker: {
            en: 'Dark',
    ...
    change_my_colour_when: {
        name: {
            ...
            pl: 'Zmień mój kolor akcentu gdy',
        },
        body: {
    ...
    this_will_replace_your_global_accent: {
        ...
        pl: 'To zastąpi twój akcent globalny (ten, którego używasz obecnie)',
    },
    solarium: {
        name: {
    ...
    refresh_pending: {
        ...
        body: {
            ...
            pl: 'Jedno z ustawień które zmieniłxś wymaga odświeżenia strony',
        },
    },
    new: {
        en: 'New',
    ...
    sources_tip: {
        ...
        pl: 'Podaj zaufane źródło gdzie jest tak podana wielkośc liter, poza stronami jak Wikipedia, RYM, AOTY, i MusicBrainz',
    },
    suggest: {
        en: 'Suggest',
        de: 'Vorschlagen',
    ...
    wiki_standard_artists: {
        ...
        pl: 'Nie używaj cytatów w nazwach albumów oraz imionach artystów',
    },
    ...
    velocity: {
        ...
        sv: 'Velocitet',
        ru: 'Скорость',
        pl: 'Dynamika', // Original "Prędkość" doesn't make sense in this context
    },
    logout: {
        en: 'Logout',
        de: 'Abmelden',
    ...
    show_guest_features: {
        ...
        body: {
            ...
            pl: 'W przeciwnym razie artyści z udziałem są zgrabnie ułożeni obok głównego artysty',
        },
    },
    track_layout: {
        name: {
    ...
    font_choice: {
        ...
        body: {
            ...
            pl: 'Wybierz czcionkę która najbardziej Ci się podoba',
        },
        custom: {
    ...
    legacy_redirects: {
        ...
        body: {
            ...
            pl: 'Domyślnie, scrobble będą poprawiane na błędne zamienniki, które są błędne o dekadę. Wyłączanie tego nie do końca naprawia ten system ale zostawia imiona artystów bez zmian.',
        },
    },
    redirect_messages: {
        name: {
        ...
        body: {
            ...
            pl: 'Te powiadomienia pozwalają ci cofać wymuszone przekierowania od Last.fm, ale mogą również być irytujące',
        },
    },
    colourful_counts: {
        name: {
    ...
    gendered_tags: {
        ...
        body: {
            ...
            pl: 'Te tagi są często zbędne i nie zawsze obejmują zakres, do którego są przeznaczone',
        },
    },
    artwork_and_grids: {
    ...
    gloss: {
        ...
        body: {
            ...
            pl: 'Dodaj efekt połysku do wszystkich okładek albumów',
        },
    },
    grid_glow: {
        name: {
            ...
            pl: 'Dodaj efekt odbicia koloru poniżej elementów siatki',
        },
        body: {
    ...
    applications_intro: {
        ...
        pl: 'Połącz swoje konto z usługami innych dostawców, aby korzystać z funkcji scrobblingu w jeszcze lepszy sposób. Upewnij się, że ufasz wymienionym poniżej usługom',
    },
    connect_app: {
        en: 'Connect {name}',
        de: 'Verbinde {name}',
    ...
    markdown_profiles: {
        ...
        body: {
            ...
            pl: "Umożliwia stosowanie znaków końca linii, pogrubienia, kursywy oraz obrazów w panelach „O mnie”",
        },
    },
    markdown_shouts: {
        name: {
        ...
        body: {
            ...
            pl: 'Umożliwia stosowanie znaków końca linii, pogrubienia, kursywy oraz obrazów w komentarzach',
        },
        preview: {
    ...
    gathering_your_plays: {
        ...
        pl: 'Zbieranie odtworzeń z albumów',
    },
    ...
    sourced_from_own_plays: {
        ...
        pl: 'Ta lista opiera się na twoich własnych odtworzeniach, ponieważ nie jest dostępna żadna oficjalna lista utworów',
    },
    submit_language: {
        name: {
            ...
            pl: 'Posługujesz się biegle jednym z obsługiwanych języków?',
        },
        body: {
            ...
            pl: 'Tłumaczenia powstają dzięki wkładowi społeczności złożonej ze wspaniałych osób, takich jak Ty',
        },
    },
    welcome_to_bleh: {
        // <br> is a line break
    ...
    choose_a_theme: {
        ...
        pl: 'Wybierz motyw, który najbardziej Ci odpowiada',
    },
    ...
    colours_explain: {
        ...
        pl: 'Wybierz kolor który Ci odpowiada albo stwórz swój ulubiony',
    },
    music_explain: {
    ...
    seasonal_particles: {
        ...
        body: {
            ...
            pl: 'Podczas chłodnych pór roku, zobacz spadające płatki śniegu ⋆⁺₊❅。',
        },
    },
    all_particles: {
    ...
    intended_for_development: {
        name: {
            ...
            pl: 'Ta strona jest przeznaczona do celów programistycznych',
        },
        body: {
    ...
    accessible_name_colours: {
        ...
        body: {
            ...
            pl: 'Zastępuje nazwy w kolorze odznak i linków kolorem nagłówka Twojego motywu',
        },
    },
    display_name_styles: {
        name: {
    ...
    underline_links: {
        ...
        body: {
            ...
            pl: 'Wymusza podkreślenie przycisków, linków i innych elementów interaktywnych',
        },
    },
    theme_loading: {
        name: {
        ...
        body: {
            ...
            pl: 'Pozwala samodzielnie ładować arkusz stylów podczas pracy nad projektem',
        },
    },
    upload: {
        en: 'Upload',
    ...
    crop_notice: {
        ...
        pl: 'Użyj kółka myszy, aby przybliżać i oddalać obraz, a następnie kliknij i przeciągnij, aby go przesunąć.',
    },
    ...
    collage_title: {
        ...
        body: {
            ...
            pl: 'Dodaj subtelny nagłówek zawierający Twoją nazwę użytkownika i użyte ustawienia',
        },
    },
    collage_grid_text: {
    ...
    style_warning: {
        ...
        pl: 'Ładowanie stylów jest wyłączone! Jeśli stało się to przypadkiem, możesz to cofnąć',
    },
    re_enable_style_loading: {
        ...
        pl: 'Ponownie włącz ładowanie stylów',
    },
    made_with_love: {
        // lowercase in design
        ...
        pl: 'stworzone z {h} przez {u} i {c}współtwórców{/c}',
    },
    supported_by: {
        // lowercase in design
    ...
    bookmark_save_msg: {
        ...
        pl: 'Znajdź swoje zakładki na stronie głównej lub {link}',
    },
    go_there_now_lower: {
        // replaces {link} above
        en: 'go there now',
    ...
    get_updates_fast: {
        ...
        body: {
            ...
            pl: 'Bądź wśród pierwszych, którzy otrzymują najnowsze poprawki i ulepszenia, gdy tylko zostaną wydane',
        },
    },
    pause_updates: {
        en: 'Pause updates',
    ...
    profile_avi_background: {
        ...
        body: {
            ...
            pl: 'Wszystkie banery oparte na obrazach artystów zostaną zastąpione awatarem użytkownika',
        },
    },
    profile_banner: {
        name: {
    ...
    profile_accent: {
        ...
        body: {
            ...
            pl: 'Dodaj do swojego profilu wyróżnienie widoczne dla wszystkich użytkowników, niezależnie od ich koloru akcentu',
        },
        reminder: {
    ...
    show_your_progress: {
        name: {
            ...
            pl: 'Pokaż swoje odsłuchania w porównaniu z zeszłym tygodniem',
        },
        body: {
            ...
            pl: 'Porównuje Twój aktualny postęp ze średnią z zeszłego tygodnia, wymaga Last.fm Pro',
        },
    },
    manual: {
        en: 'Manual',
    ...
    yellow: {
        ...
        sv: 'Gul',
        ru: 'Желтый',
        pl: 'Żółty', // Good luck pronouncing that
    },
    lime: {
        en: 'Lime',
        de: 'Limette',
    ...
    rainbow: {
        ...
        body: {
            ...
            pl: 'Przekształć swoją historię słuchania w wir kolorów',
        },
    },
    atlas: {
        name: {
    ...
    labs_cta: {
        ...
        pl: 'Jeśli szukasz czegoś więcej, wypróbuj {a}funkcję Labs{/a} od Last.fm',
    },
    compare_description: {
        ...
        pl: 'Znajdź wspólnych artystów, albumy i utwory z innym użytkownikiem',
    },
    enter_a_profile: {
        en: 'Enter a profile',
        de: 'Profil eingeben',
    ...
    lyrics: {
        ...
        body: {
            ...
            pl: 'Zgadnij utwór na podstawie losowego fragmentu tekstu',
        },
    },
    jumbled_title: {
        en: 'Jumbled title',
    ...
    obsession_expired: {
        ...
        pl: 'Twoja obsesja wygasła', // sounds weird but it is what it is -- Pkhtz
    },
    ...
    no_mutual_listeners: {
        ...
        pl: 'Nie masz wspólnych słuchaczy',
    },
    no_mutual_listeners_explain: {
        ...
        pl: 'Może to wynikać po prostu z braku wspólnych obserwujących, którzy słuchają, albo z nieprawidłowego przekierowania strony.',
    },
    navigation_items: {
        name: {
            en: 'Quick access',
    ...
    branding_type: {
        ...
        body: {
            ...
            pl: 'Wybierz który rodzaj brandingu chcesz używać w nagłówku ',
        },
    },
    rain: {
        name: {
    ...
    auto_correct_scrobbles: {
        ...
        body: {
            ...
            pl: 'Zmienia nazwy artystów na podstawie starego systemu przekierowań Last.fm sprzed 2015 roku, powodując wiele problemów',
        },
        warning: {
    ...
    preferred_affiliate: {
        name: {
            ...
            pl: 'Preferowane źródło odtwarzania',
        },
        body: {
    ...
    oracle_beta: {
        ...
        body: {
            ...
            pl: 'Przeprojektowany widok albumów i utworów korzystający z danych MusicBrainz. Może zostać wydany w przyszłości lub porzucony. Podziel się opinią na temat korzystania z tej funkcji.',
        },
    },
    label: {
        en: 'Label',
    ...
    romanise_titles: {
        ...
        pl: 'Romanizuj tytuły utworów i nazwy artystów dla',
    },
    romanise_jp: {
        en: '日本語 (Japanese)',
        de: '日本語 (Japanisch)',
    ...
    romanise_require: {
        ...
        pl: 'Romanizacja wymaga włączenia korekt lotus lub inteligentnych tagów utworów',
    },
    disc_number: {
        en: 'Disc {n}',
        de: 'Disc {n}',
    ...
    music_links: {
        ...
        body: {
            ...
            pl: 'Wybierz, które usługi wyświetlać dla artystów, albumów i utworów',
        },
    },
    amount_translated: {
    ...
    plot: {
        ...
        body: {
            ...
            pl: 'Twórz wykresy na podstawie bibliotek użytkowników',
        },
    },
    card: {
        name: {
    ...
    translator: {
        ...
        body: {
            ...
            pl: 'Wyświetl szczegółowe informacje o wszystkich językach, aby ułatwić tłumaczenie',
        },
    },
    translate: {
        en: 'Translate',
    ...
    now_notice: {
        ...
        body: {
            ...
            pl: 'Jeśli masz subskrypcję Last.fm Pro, możesz w każdej chwili wyświetlić aktualnie odtwarzany utwór w menu swojego profilu',
        },
    },
    current_status: {
        en: 'Current status',
    ...
    status_cafe: {
        ...
        body: {
            ...
            pl: 'Umieść swój aktualny status na profilu. Możesz dowolnie zmieniać jego położenie, edytując sekcję „O mnie”.',
        },
    },
    date_at_time: {
    ...
    valentine: {
        ...
        pl: 'dla osoby którą najbardziej kocham, {u} ♡ ',
    },
    view_details: {
        en: 'View details',
        de: 'Details anzeigen',
    ...
    popup_navigation_menu: {
        ...
        body: {
            ...
            pl: 'Kliknij prawym przyciskiem myszy, aby wybrać, które akcje mają być tutaj wyświetlane',
        },
    },
    popup_inbox: {
        title: {
    ...
    popup_profile_name_style: {
        ...
        body: {
            ...
            pl: 'To ekskluzywne korzyści dla sponsorów w podziękowaniu za wsparcie bleh',
        },
    },
    popup_markdown: {
        title: {
        ...
        body: {
            ...
            pl: 'Formatuj tekst, dodawaj obrazy i linki, wspominaj użytkowników i korzystaj z wielu innych możliwości, zależnie od sytuacji',
        },
    },
    popup_search: {
        title: {
    ...
    oracle_sources_tip_track: {
        ...
        pl: 'Z jakimi albumami utwór powinien być powiązany, np. Dawn FM zamiast After Hours',
    },
    oracle_sources_tip_album: {
        ...
        pl: 'Które wydanie albumu spodziewano się zobaczyć? Podaj linki i krótko wyjaśnij, dlaczego.',
    },
    switch: {
        // like switch places
        en: 'Switch',
    ...
    shoutbox_failed: {
        ...
        pl: 'Wystąpil błąd podczas ładowania rozmów “(ノ _ <,, )',
    },
    track_name: {
        en: 'Track name',
        de: 'Titel',
    ...
    no_tracks_found_mb: {
        ...
        pl: 'Nie znaleziono utworów, możliwy bląd MusicBrainz',
    },
    ...
    died: {
        ...
        ru: 'Дата смерти',
        it: 'Morto il',
        pl: 'Data śmierci', // there is no gender neutral in polish instead this means literally Date of death. I think it feels more natural in the context
    },
    formed: {
    ...
    show_disc_image: {
        name: {
            ...
            pl: 'Pokaż płytę dla albumów i utworów',
        },
        body: {
    ...
    count_bar_right: {
        ...
        body: {
            ...
            pl: 'Kontroluj kierunek paska postępu i tekstu',
        }
    },
    better_with_friends: {
